    ...
    public String gen_Report() {
        ...
        if (gotFormat == "") {
            showMessage("Please Select Report Format");
                ...
                case "EmpProjWise":
                    reportBean.setReportURLName("userid=lihs/lihsir@orcl&domain=classicdomain&report=C:/LIHS_Reports/Employee_Project_Wise_Report&");
                    break;
                
                case "EmpSal":
                    reportBean.setReportURLName("userid=lihs/lihsir@orcl&domain=classicdomain&report=C:/LIHS_Reports/Employee_Salary_Sheet_Report&");
                    break;
                
               case "EmpAtt":
                        reportBean.setReportURLName("userid=lihs/lihsir@orcl&domain=classicdomain&report=C:/LIHS_Reports/Employee_Attendance_Report&");
                        break;
                    case "EmpSalAllow":
                             reportBean.setReportURLName("userid=lihs/lihsir@orcl&domain=classicdomain&report=C:/LIHS_Reports/Employee_Salary_Allowances_Report&");
                             break; 
